...
class Apartment {
 ...
 public:
   ...
   * [31.772425, 35.213506]
   * @param other reference to an apartment
  ...
  friend std::ostream &operator<<
	  (std::ostream &os, const Apartment &apartment);

 private:
  /**
   * Calculates the distance between two apartments
   * @param apartment reference to an apartment
   * @return the distance between this to apartment
   */
  double get_dist (const Apartment &apartment) const;
};

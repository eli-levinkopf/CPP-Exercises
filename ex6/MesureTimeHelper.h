...
/**
 *
 * Given a path to the file apartments100/apartments1000/apartments1000 return
 * its corresponding vector
 * @param file_name A path to the given apartments file, in your pc.
 * @return a vector of st::pair<double, double> where each pair represents
 * the x and y coordinates of an apartment.
 */
